...
def show_image():
    ...
    image_list = [
        PhotoImage(file=resource_path(f"./catspin/frame_00{i}_delay-0.05s.gif")) for i in range(10)
    ] + [
        PhotoImage(file=resource_path(f"./catspin/frame_0{i}_delay-0.05s.gif")) for i in range(10, 99)
    ] + [
        PhotoImage(file=resource_path(f"./catspin/frame_{i}_delay-0.05s.gif")) for i in range(100, 104)
    ]
