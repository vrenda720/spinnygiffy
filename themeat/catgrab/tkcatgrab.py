...
def show_image():
    ...
    image_list = [
        PhotoImage(file=resource_path(f"./catgrab/frame_0{i}_delay-0.07s.gif")) for i in range(10)
    ] + [
        PhotoImage(file=resource_path(f"./catgrab/frame_{i}_delay-0.07s.gif")) for i in range(10, 42)
    ]
